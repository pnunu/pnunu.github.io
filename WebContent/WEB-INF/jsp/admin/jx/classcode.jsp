            ...
            <table class="am-table am-table-striped am-table-hover table-main" style="">
              <thead>
				<tr>
					...
					<th class="table-title">课程分类名称</th>
					<!-- <th class="table-type">描述</th> -->
					<th class="table-type">图片URL</th>
					<th class="table-type">老师人数</th>
					<th class="table-type">学生人数</th>
					<th class="table-set">操作</th>
				</tr>
			  </thead>
              <tbody id="userList">
                <c:forEach items="${classCodes }" var="codes" varStatus="status"> 
				<tr>
					...
					<td>${codes.teacherNum }</td>
					<td>${codes.studentNum }</td>
					<td>
